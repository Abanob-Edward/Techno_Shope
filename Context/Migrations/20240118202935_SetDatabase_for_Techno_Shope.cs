...
{
    /// <inheritdoc />
    public partial class SetDatabase_for_Techno_Shope : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Inch = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCartItems_CartItems_CartId",
                        column: x => x.CartId,
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCartItems_Products_Pro_Id",
                        column: x => x.Pro_Id,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ProductInOrders_Orders_OrderNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCartItems_CartId",
                table: "ProductCartItems",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCartItems_ItemID",
                table: "ProductCartItems",
                column: "ItemID");

            migrationBuilder.CreateIndex(
                name: "IX_ProductCartItems_Pro_Id",
                table: "ProductCartItems",
                column: "Pro_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInOrders_OrderNumber",
                table: "ProductInOrders",
                column: "OrderNumber");
