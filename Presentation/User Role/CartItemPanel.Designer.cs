namespace Presentation.User_Role
{
    partial class CartItemPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Reload
            // 
            Reload.BackColor = Color.FromArgb(33, 42, 81);
            Reload.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point, 0);
            Reload.ForeColor = SystemColors.ControlLight;
            Reload.Location = new Point(1193, 697);
            Reload.Margin = new Padding(4);
            Reload.Name = "Reload";
            Reload.Size = new Size(194, 66);
            Reload.TabIndex = 7;
            Reload.Text = "Reload";
            Reload.UseVisualStyleBackColor = false;
            Reload.Click += button3_Click;
            // 
            // CartItemPanel
            // 
